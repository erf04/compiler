...
{
      14,     0,    -1,     3,     6,    15,     5,    -1,    15,     9,
      16,    -1,    15,    10,    16,    -1,    16,    -1,    17,     7,
      16,    -1,    17,     8,    16,    -1,    17,    -1,    11,    15,
      12,    -1,     4,    -1
};
...
{
  "$end", "error", "$undefined", "ID", "NUMBER", "END", "EQUAL", "PLUS",
  "MINUS", "MULTIPLY", "DIVIDE", "LPAREN", "RPAREN", "$accept", "e",
  "expr", "t", "f", 0
};
#endif
...
{
       5,     3,    12,    13,    11,    16,     1,     6,    12,    13,
      17,    18,    19,    20,    14,    15,     4,    10
};

static const yytype_uint8 yycheck[] =
{
       4,     6,     9,    10,     5,    12,     3,    11,     9,    10,
      12,    13,    14,    15,     7,     8,     0,     6
};
...
{
       0,     3,    14,     6,     0,     4,    11,    15,    16,    17,
      15,     5,     9,    10,     7,     8,    12,    16,    16,    16,
      16
};
